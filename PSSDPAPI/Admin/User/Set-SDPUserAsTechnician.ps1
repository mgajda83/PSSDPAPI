Function Set-SDPUserAsTechnician
{
	<#
	.SYNOPSIS
		Change User as Technican
	...
	.EXAMPLE
		...
		$Technican = Set-SDPUserAsTechnician -UserId 54321 -InputData $InputData
	...
	Process
	{
		$InvokeParams = @{
			...
			ApiKey = $ApiKey
			Method = "PUT"
			EntityUri = "/api/v3/users/$UserId/change_as_technician"
			InputData = $InputData
		}

		#Send request
		If ($PSCmdlet.ShouldProcess($UserId,"Change user by id"))
		{
